...
public enum EnumOptions {
	...
	DYNAMIC_FOV("prcmenu.options.dynamicFOV", false, true), FULLBRIGHT("prcmenu.mods.fullBright", false, true), KEYSTROKES("prcmenu.mods.keyStrokes", false, true), VIGNETTE("prcmenu.mods.vignette", false, true);
